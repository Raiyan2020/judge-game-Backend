...
Route::group(['middleware' => 'setLocale'], function () {
    ...
    Route::group(['middleware' => 'auth:sanctum'], function () {
        ...
        // The judge WITHDRAWS an outstanding opinion request, lifting the
        // `awaiting_opinion` gate so they aren't blocked forever if the awaited
        // party never files. NOT subscription-gated: this is an un-sticking
        // action (judge-only authorization is enforced in the service). Returns
        // the updated case so the app re-renders with the gate lifted.
        Route::post('legal-cases/{legalCase}/cancel-opinion-request', [LegalCaseController::class, 'cancelOpinionRequest']);
